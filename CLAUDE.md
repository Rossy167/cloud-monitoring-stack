...
- Running two coders (or two supervisors) concurrently *within this same repo* is what caused the original worktree/branch mess this project recovered from — don't do it. Two agents running concurrently across two genuinely separate repos (e.g. this repo + the portfolio site) is fine.
