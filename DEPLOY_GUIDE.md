...
Review the plan. It should create: a project service (Compute API), a VPC + subnet, two firewall rules (22 from your IP only, 80/443 from anywhere), a static IP, and one `e2-micro` VM. Nothing else. Type `yes` to confirm.
